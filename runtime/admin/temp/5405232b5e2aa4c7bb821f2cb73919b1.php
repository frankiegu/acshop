<?php /*a:2:{s:56:"H:\phpStudy\wplus\AcShop\app\admin\view\index\index.html";i:1603014103;s:59:"H:\phpStudy\wplus\AcShop\app\admin\view\layout\default.html";i:1603014763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
//"echarts", "echarts-theme",  echarts, undefined,

    var options = {
        iniUrl: "<?php echo __url("admin/ajax/initAdmin"); ?>",    // 初始化接口
        clearUrl: "<?php echo __url("admin/ajax/clearCache"); ?>", // 缓存清理接口
    ...
    $('.login-out').on("click", function () {
        ea.request.get({
            ...
            window.location = "<?php echo __url("admin/login/index"); ?>";
            })
        });
    });
});
